...
VALUES
(1, 300000, 50000, 100000, '2025-01', '管理職手当あり'),
(2, 250000, 30000, 50000,  '2025-01', '通常支給'),
(3, 220000, 20000, 0,      '2025-01', '試用期間中'),
(4, 280000, 40000, 70000,  '2025-01', '海外プロジェクト'),
(5, 200000, 10000, 0,      '2025-01', '新人社員'),

(1, 300000, 50000, 120000, '2025-02', '業績ボーナス'),
(2, 250000, 30000, 60000,  '2025-02', '通常支給'),
(4, 280000, 40000, 80000,  '2025-02', '特別手当');
...
VALUES
(1, '2025-01-10', '東京駅', '新宿駅', 'train', 200, '会議出席'),
(2, '2025-01-11', '横浜駅', '品川駅', 'train', 300, '客先訪問'),
(3, '2025-01-12', '大宮駅', '池袋駅', 'train', 320, '研修'),
(4, '2025-01-15', '羽田空港', '東京駅', 'bus',   1000, '出張移動'),
(5, '2025-01-18', '渋谷駅', '六本木駅', 'taxi',  1500, '深夜対応'),

(1, '2025-02-05', '新宿駅', '東京駅', 'train', 200, '定例会議'),
(2, '2025-02-07', '品川駅', '横浜駅', 'train', 300, '客先訪問'),
(4, '2025-02-20', '大阪駅', '新大阪駅', 'taxi', 1200, '緊急対応');
